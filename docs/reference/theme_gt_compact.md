...
- data:
  ...
  *The gt table data object*
  ...
  of the [`gt()`](https://rdrr.io/pkg/gt/man/gt.html) function.

- table.font.size:

  Font size passed to
  [`gt::tab_options()`](https://rdrr.io/pkg/gt/man/tab_options.html).
...
- ...:
  ...
  [`tab_options()`](https://rdrr.io/pkg/gt/man/tab_options.html)
  function
