...
test_that("data-statistic blocks keep the grammar order-independent", {
...
test_that("print.mesa describes the data-statistic blocks", {
	...
	expect_true(any(grepl(
		"events \\+ rate \\(per 100 person-years\\), rate difference", out
	)))
})
